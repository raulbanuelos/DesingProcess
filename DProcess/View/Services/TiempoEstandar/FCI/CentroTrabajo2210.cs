...
{
    public class CentroTrabajo2210 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Atributos
        private double _h1;
        #endregion
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round(((200.05873739 * _h1) / (296.208)) * 100, 3, MidpointRounding.AwayFromZero);
