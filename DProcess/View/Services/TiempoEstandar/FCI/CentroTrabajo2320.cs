...
{
    public class CentroTrabajo2320 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Atributos
        private double _h1;
        #endregion
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round(((1496.75 * _h1) / 165.6) * 100, 3, MidpointRounding.AwayFromZero);
