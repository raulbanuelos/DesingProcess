...
{
    public class CentroTrabajo2190 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Atributos
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round(28.007 / (((1 / _width) * 2) * 36) * 100, 3, MidpointRounding.AwayFromZero);
