...
{
    public class CentroTrabajo2160 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Propiedades
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round(0.03893460 * 100, 3, MidpointRounding.AwayFromZero);
