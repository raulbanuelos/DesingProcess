...
{
    public class CentroTrabajo2180 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Propiedades
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round(0.02562550 * 100, 3, MidpointRounding.AwayFromZero);
