...
{
    public class CentroTrabajo2100 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Atributos
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round( ((_width * 87.60) / 324) * 100,3, MidpointRounding.AwayFromZero);
