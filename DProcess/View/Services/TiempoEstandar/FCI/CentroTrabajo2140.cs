...
{
    public class CentroTrabajo2140 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Propiedades
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round(0.12600772 * 100, 3, MidpointRounding.AwayFromZero);
