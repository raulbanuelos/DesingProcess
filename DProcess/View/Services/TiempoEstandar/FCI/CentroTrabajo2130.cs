...
{
    public class CentroTrabajo2130 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Propiedades
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round(0.130482 * 100, 3, MidpointRounding.AwayFromZero);
