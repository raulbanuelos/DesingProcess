...
{
    public class CentroTrabajo230 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Propiedades
        ...
        public CentroTrabajo230()
        {
            ...
            PropiedadBool opeFranklin = new PropiedadBool { Nombre = "Operacion ROUGH CAM TURN (FRANKLIN)", DescripcionCorta = "Operacion Franklin", DescripcionLarga = "¿El componente para por operación ROUGH CAM TURN (FRANKLIN)?", Imagen = null };
