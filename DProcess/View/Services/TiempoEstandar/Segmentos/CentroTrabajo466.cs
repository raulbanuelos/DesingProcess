...
{
    public class CentroTrabajo466 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Propiedades
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round((((((diametro * 28.97555556) / 4.0906) + 110.152524057692) * width) / 126.0396) * 100, 3);
