...
{
    public class CentroTrabajo516 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Atributos
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round(((54.0958) / (12 * (2 * (13 / _width))) * 100), 3, MidpointRounding.AwayFromZero);
