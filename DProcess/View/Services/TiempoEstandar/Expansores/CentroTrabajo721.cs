...
{
    public class CentroTrabajo721 : BaseCentroTrabajo, ICentroTrabajo
    {
        #region Atributos
        ...
        public void Calcular()
        {
            ...
            TiempoMachine = Math.Round( ((1467.65 / (36 * ((312 / width) * 2))) * 100), 3, MidpointRounding.AwayFromZero);
