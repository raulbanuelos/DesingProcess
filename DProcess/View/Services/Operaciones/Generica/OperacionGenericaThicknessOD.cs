...
{
    public class OperacionGenericaThicknessOD : GenericOperation, IOperacion, IObserverThickness
    {
        #region Properties
        ...
        #region Constructor
        public OperacionGenericaThicknessOD()
        {
            NombreOperacion = "OPERACIÓN THICKNESS OD";
        }
        #endregion
    }
}
