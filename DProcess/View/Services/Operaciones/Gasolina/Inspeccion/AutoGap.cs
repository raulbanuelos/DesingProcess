...
{
    public class AutoGap : GenericOperation,IOperacion
    {
        #region Properties
        ...
        public void InicializarDatosGenerales()
        {
            ...
            NombreOperacion = "100% GAP INSPECTION (AUTOGAP) GASOLINE";
            CentroCostos = "32012562";
            CentroTrabajo = "820";
            ControlKey = "MA42";
            IdXML = "IDCentroTrabajo820";
