...
{
    public class ProtectorInfMoly_VM: INotifyPropertyChanged
    {
        #region Attributtes
        ...
        {
            ListaHerramentales = DataManager.GetAllProtectorInfMoly(texto);
        }
        ...
        private async void buscarOptimos()
        {
            ...
            if (Diam != 0)
            {
                ...
                ListaOptimos = DataManager.GetProtectorInfMoly(Diam);
        ...
        public ProtectorInfMoly_VM()
        {
            dialog = new DialogService();
            busquedaMoly(string.Empty);
            Titulo = "Protector Inferior Moly";
            Texto = "Medida Collar";
        }
