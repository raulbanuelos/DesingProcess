...
{
    public class BushingCromo : INotifyPropertyChanged
    {
        #region Attributtes
        ...
        {
            ListaHerramentales = DataManager.GetAllBushingCromo(texto);
        }
        ...
        private async void buscarOptimos()
        {
            ...
            if (Diam != 0)
            {
                ...
                ListaOptimos = DataManager.GetBushingCromo(Diam);
                //Obtenemos la lista del mejor herramental.
               
                ListaMejores = DataManager.SelectBest_BushingCromo(ListaOptimos);
