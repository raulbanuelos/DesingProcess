        ...
        private bool validarHII(out string mensaje)
        {
            ...
            foreach (Archivo archivo in ListaDocumentos)
            {
                ...
                try
                {
                    ...
                    foreach (Microsoft.Office.Interop.Excel.Worksheet sheet1 in ExcelWork.Sheets)
                    {
                        string Numeracion = Convert.ToString(sheet1.Range["HOJAS"].Value);
        ...
        private bool validarAVY(out string mensaje)
        {
            ...
            foreach(Archivo archivo in ListaDocumentos)
            {
                ...
                try
                {
                    ...
                    if (ValidacionNumeracion == false)
                    {
                        mensaje = "La numeración de las hojas está mal.";
                        return false;
                    }
                    ...
                    if (date.Year != FechaFin.Year || date.Month != FechaFin.Month || date.Day != FechaFin.Day)
                    {
                        ...
                        mensaje = "La fecha elaboró es incorrecta. \nLa fecha en el archivo debe ser: " + FechaFin.Year + "-" + mes + "-" + dia;
                        return false;
                    }
                    ...
                    if (date1.Year != FechaFin.Year || date1.Month != FechaFin.Month || date1.Day != FechaFin.Day)
                    {
                        ...
                        mensaje = "La fecha revisión es incorrecta. \nLa fecha en el archivo debe ser: " + FechaFin.Year + "-" + mes + "-" + dia;
                        return false;
                    ...
                    {
                        mensaje = "El usuario aprobó está incorrecto.\nEl usuario aprobó en el archivo debe ser: " + ListaUsuarios.Where(x => x.usuario == usuarioAutorizo).FirstOrDefault().NombreCompleto;
                        return false;
                    }
                    if (codigo != SelectedDocumento.nombre)
                    {
