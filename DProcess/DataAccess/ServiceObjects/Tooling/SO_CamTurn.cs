...
namespace DataAccess.ServiceObjects.Tooling
{
    public class SO_CamTurn
    {
        ...
        /// <returns></returns>
        public int SetCollarSpacer(string codigo, string plano, string medidaNom, double dimE, double dimF)
        {
            try
            {
            ...
            try
            {
                ...
                using (var Conexion= new EntitiesTooling())
                {
                    ...
                    var lista = (from w in Conexion.WorkCam
                                 ...
                                 select new
                                 {
                                     w.Id_WorkCam,w.MedidaNominal,m.Codigo,m.Descripcion,m.Activo
                                 }).ToList();
                    //Retornamos el resultado de la consulta.
                    return lista;
                }
